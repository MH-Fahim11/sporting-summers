...
const UserHome = () => {
    ...
    return (
      ...
      <h1 className=" text-4xl font-bold p-6">Welcome Back ,{user?.displayName}</h1>
      <div className="stats shadow">
        ...
        <div className="stat">
          ...
          <div className="stat-title">Spend Time</div>
          <div className="stat-value">100H</div>
        ...
        <div className="stat">
          ...
          <div className="stat-value">3th</div>
          <div className="stat-desc">↘︎ 90 (14%)</div>
        </div>
      </div>
    </div>
